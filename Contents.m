% A-NEW-METHOD-FOR-ELLIPSE-DETECTION-2015
%
% Files
%   accuracyMapScripts - Scripts for producing the data maps for 'A New Method for Ellipse Detection' by Nelson et al. (2015)
